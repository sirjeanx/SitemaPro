...
export function TablaPersonal({
  ...
  const { eliminarusers } = useUsersStore();
  const editar = (data) => {
  ...
  const columns = [
    ...
    },
    {
      ...
      header: "Nº Documento",
      cell: (info) => (
        <div data-title="Nº Documento" className="ContentCell">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    ...
    //   header: "Telefono",
    //   cell: (info) => (
    //     <div data-title="Telefono" className="ContentCell">
    //       <span>{info.getValue()}</span>
    //     </div>
    //   ),
    // },
    ...
    //   header: "F.Registro",
    //   cell: (info) => (
    //   <div data-title="F.Registro" className="ContentCell">
    //       <span>{info.getValue()}</span>
    //     </div>
    //   ),
    // },
    {
      ...
      header: "T.de usuario",
      cell: (info) => (
        <div data-title="T.de usuario" className="ContentCell">
          <span>{info.getValue()}</span>
        </div>
      ),
    },
    ...
    //   cell: (info) => (
    //     <div data-title="T.de Documento" className="ContentCell">
    //       <span>{info.getValue()}</span>
    //     </div>
    //   ),
    // },
    ...
    //   header: "Correo",
    //   cell: (info) => (
    //     <div data-title="Correo" className="ContentCell">
    //       <span>{info.getValue()}</span>
    //     </div>
    //   ),
    // },
