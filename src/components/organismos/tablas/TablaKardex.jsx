...
export function TablaKardex({
  ...
  },
  {
    ...
    cell: (info) => {
      ...
      return (
        <Colorcontent
          data-title="Tipo"
          color={tipo === "salida" ? "#ed4d4d" : "#30c85b"}
          className="ContentCell contentCategoria"
        >
          {tipo}
        </Colorcontent>
      );
  ...
  },
  {
    ...
    enableSorting: false,
    cell: (info) => (
      <span data-title="Detalle" className="ContentCell">
        {info.getValue()}
      </span>
    ),
    enableColumnFilter: true,
  ...
  },
  {
    ...
    enableSorting: false,
    cell: (info) => (
      <span data-title="Usuario" className="ContentCell">
        {info.getValue()}
      </span>
    ),
    enableColumnFilter: true,
